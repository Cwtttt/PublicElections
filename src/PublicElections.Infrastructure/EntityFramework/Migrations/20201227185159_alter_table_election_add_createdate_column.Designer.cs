...
namespace PublicElections.Infrastructure.EntityFramework.Migrations
{
    ...
    [Migration("20201227185159_alter_table_election_add_createdate_column")]
    partial class alter_table_election_add_createdate_column
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PublicElections.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PublicElections.Domain.Entities.ApplicationUser", null)
                        .WithMany()
